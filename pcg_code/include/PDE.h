...
class PDE{
    ...
    public:
        ...
        /*@brief Calculates residual and its norm on the grid res=rhs-A*u
         *
         * @param res The Grid where residual has to be stored
         * @param rhs The Grid where rhs is stored
         * @return residual norm
         */
        double residual(Grid *res, Grid *rhs, Grid *u);
