...
double axpby(Grid *res, double a, Grid *x, double b, Grid *y, bool halo=false);
double copy(Grid *res, double a, Grid *x, bool halo=false);
double dotProduct(Grid *x, Grid *y, bool halo=false);
double dotProduct_1(Grid *x, bool halo=false);
